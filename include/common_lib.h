...
#include "msclio/Pose6D.h"
#include "options.h"
#include "so3_math.h"
#include "keyPointsExtract/LidarPoint.h"
...
using PointCloudType = pcl::PointCloud<velodyne_ros::Point>;
